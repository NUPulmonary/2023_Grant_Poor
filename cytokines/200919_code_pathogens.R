...
code_pathogens = function(bal_data)
{
  ...
  bal_data$any_bacterial = (bal_data$ENTEROBACTER_CLOACAE_COMPLEX == "Positive" |
                         bal_data$ESCHERICHIA_COLI == "Positive" |
                         bal_data$HAEMOPHILUS_INFLUENZAE == "Positive" |
                         bal_data$KLEBSIELLA__ENTEROBACTER__AEROGENES == "Positive" |
                         ...
                         bal_data$LEGIONELLA_PNEUMOPHILA == "Positive" |
  ...
  bal_data$any_parainfluenza = (bal_data$PARAINFLUENZA_VIRUS == "Positive" |
  ...
  bal_data$any_rsv = (bal_data$RESPIRATORY_SYNCYTIAL_VIRUS_RESPAN22 == "Positive")
